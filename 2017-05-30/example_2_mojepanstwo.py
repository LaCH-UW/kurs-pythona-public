...
klucz_daty_rejestracji = 'krs_podmioty.data_rejestracji'
...
print(all_elements[0]['slug'], all_elements[0]['data'][klucz_daty_rejestracji], all_elements[0]['data']['krs_podmioty.adres_kod_pocztowy'])